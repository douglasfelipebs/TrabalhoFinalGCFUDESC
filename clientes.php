...
<div class="wrapper">
    ...
    <div class="main-panel">
                    ...
                    <div class="col-md-12">
                        <div class="card card-plain">
                            ...
                            <div class="header title-add">
                                ...
                                <button class="btn" type="button" data-toggle="modal" data-target="#ModalAddCliente"><i class="fa fa-plus"></i></button>
                            </div>
        ...
        <div class="modal fade" data-backdrop="false" id="ModalAddCliente" tabindex="-1" role="dialog" aria-labelledby="TituloModalCentralizado" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-items">
                    <div class="modal-header">
                        <h5 class="modal-title" id="TituloModalCentralizado">Cadastro de Cliente
